...
.setTimestamp()
.setFooter("I am a bot and cannot reply to DM's. For assistance, please reach out to a staff member.")
.setColor("#f5f5f5")
.setDescription([
    ...
    ` `,
    "● First, you will have to read the Community Requirements to esure you are eligable to apply for Deputy Roleplay: https://bit.ly/3ahPEUZ",
    "● Secondly, you will also have to read our Rules & Regulations: https://bit.ly/3e9dbcl",
    "● Finally, you can apply using the Application Form. When doing so, please make sure to include as many details as possible and reach the sentence requirements outlined above every open question as if you fail to do so, there is a high possibility you will be declined: https://bit.ly/3koxkOc",
    ` `,
