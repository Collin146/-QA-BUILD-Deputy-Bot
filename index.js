...
bot.on("ready", async () => {
    ...
    if (messageReaction.message.id === "756167437489275043") {
        ...
        if (messageReaction.emoji.id === drpmember.id) {
          ...
          if (mainguild.member(mainguild.members.get(user.id))) {
        ...
        if (messageReaction.emoji.id === drprecruit.id) {
            ...
            if (trainguild.member(trainguild.members.get(user.id))) {
        ...
        if (messageReaction.emoji.id === drpapplicant.id) {
          ...
          if (interviewguild.member(interviewguild.members.get(user.id))) {
